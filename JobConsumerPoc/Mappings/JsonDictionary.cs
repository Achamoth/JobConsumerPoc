...
{
    public class JsonDictionary<TKey, TValue> : IUserType
        where TKey: notnull
    {
        public SqlType[] SqlTypes => [new StringSqlType()];

        public Type ReturnedType => typeof(Dictionary<TKey, TValue>);
        ...
        public object DeepCopy(object value)
        {
            ...
            var incoming = value as IDictionary<TKey, TValue>;
            if (incoming != null)
            {
        ...
        public object NullSafeGet(DbDataReader rs, string[] names, ISessionImplementor session, object owner)
        {
            ...
            var json = (string)r;
            var result = JsonConvert.DeserializeObject<Dictionary<TKey, TValue>>(json);
            return result;
        }
